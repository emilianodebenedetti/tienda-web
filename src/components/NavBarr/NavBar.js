        ...
        <div className="drawer ">
          ...
          <div className='text-center text-black '>
            ...
            <div className="w-full navbar bg-black" >
              ...
              <Link to="/" className=" navbar-start px-2 mx-2 text-xl text-white">
                <img width="180" alt="Logo" className="" crossorigin="anonymous" data-src="https://admitone.vtexassets.com/arquivos/logo_blanco_admitone.svg" loading="lazy" src="https://admitone.vtexassets.com/arquivos/logo_blanco_admitone.svg"></img>
              </Link>
